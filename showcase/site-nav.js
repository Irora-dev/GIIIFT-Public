...
(function () {
  ...
  function injectCss() {
    ...
    st.textContent = [
      ".site-nav{position:sticky;top:18px;z-index:400;max-width:1320px;margin:0 auto 22px;padding:0 clamp(16px,4vw,40px);font-family:'Inter',sans-serif}",
      ".site-nav .snav-pill{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:11px 14px 11px 22px;border-radius:100px;background:rgba(22,24,30,0.55);-webkit-backdrop-filter:blur(40px);backdrop-filter:blur(40px);border:1px solid rgba(255,255,255,0.12);box-shadow:0 24px 48px -12px rgba(0,0,0,0.5)}",
      ".site-nav .snav-logo{font-family:'Bowlby One',sans-serif;font-size:22px;letter-spacing:-0.04em;color:#fff;text-decoration:none;transform:rotate(-3deg);display:inline-flex;align-items:baseline;gap:1px;user-select:none}",
      ".site-nav .snav-logo .i1{color:#FF3B6F}.site-nav .snav-logo .i2{color:#FFD93D}.site-nav .snav-logo .i3{color:#4ECDC4}",
      ".site-nav .snav-logo .dot{width:8px;height:8px;background:#fff;border-radius:50%;display:inline-block;transform:translateY(-2px);margin-left:4px}",
      ".site-nav .snav-links{display:flex;gap:4px;background:rgba(0,0,0,0.22);border:1px solid rgba(255,255,255,0.12);padding:5px;border-radius:100px}",
      ".site-nav .snav-links a{padding:8px 18px;border-radius:100px;font-size:14px;font-weight:600;color:rgba(255,255,255,0.6);text-decoration:none;cursor:pointer;transition:color .2s,background .2s}",
      ...
      ".site-nav .nav-vault,.site-nav .nav-login{font-family:'Inter',sans-serif;font-weight:600;font-size:14px;line-height:1;padding:11px 18px;border-radius:100px;border:1px solid rgba(255,255,255,0.12);background:rgba(255,255,255,0.08);color:#fff;text-decoration:none;cursor:pointer;display:inline-flex;align-items:center;gap:8px;transition:background .2s}",
      ".site-nav .nav-vault:hover,.site-nav .nav-login:hover{background:rgba(255,255,255,0.15)}",
      ".site-nav .nav-vault .v-dot{width:7px;height:7px;border-radius:50%;background:#00FF9D;box-shadow:0 0 8px #00FF9D}",
      "@media(max-width:720px){.site-nav .snav-links{display:none}}",
      /* sign-in gate (vault / send when signed out) */
      ".giiift-gate{position:fixed;inset:0;z-index:350;display:flex;align-items:center;justify-content:center;padding:24px;background:rgba(8,8,11,0.66);-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);font-family:'Inter',sans-serif;animation:giiift-gate-in .3s ease both}",
      "@keyframes giiift-gate-in{from{opacity:0}to{opacity:1}}",
      ".giiift-gate-card{text-align:center;max-width:420px;width:100%;padding:42px 36px;border-radius:28px;background:rgba(22,24,30,0.62);border:1px solid rgba(255,255,255,0.12);box-shadow:0 30px 70px -20px rgba(0,0,0,0.7)}",
      ".giiift-gate-ic{width:60px;height:60px;margin:0 auto 16px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.12)}",
      ".giiift-gate-ic svg{width:26px;height:26px;fill:none;stroke:#fff;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}",
      ".giiift-gate-card h2{font-size:28px;font-weight:700;color:#fff;letter-spacing:-0.02em;margin:0 0 8px}",
      ".giiift-gate-card p{font-size:15px;color:rgba(255,255,255,0.6);margin:0 0 26px}",
      ".giiift-gate-btn{font-family:'Inter',sans-serif;font-weight:700;font-size:15px;padding:15px 36px;border-radius:100px;border:1px solid rgba(255,255,255,0.22);background:rgba(255,255,255,0.12);color:#fff;cursor:pointer;transition:background .2s,transform .15s}",
      ".giiift-gate-btn:hover{background:rgba(255,255,255,0.2);transform:translateY(-1px)}",
      ".giiift-gate-demo{display:block;margin:16px auto 0;background:none;border:none;color:rgba(255,255,255,0.5);font-family:'Inter',sans-serif;font-size:13.5px;font-weight:600;cursor:pointer;transition:color .2s}",
      ".giiift-gate-demo:hover{color:#fff}",
      /* demo-mode badge (login bypass active) */
      ".giiift-demo-badge{position:fixed;left:18px;bottom:18px;z-index:420;display:inline-flex;align-items:center;gap:9px;padding:8px 8px 8px 14px;border-radius:100px;background:rgba(22,24,30,0.7);-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.14);box-shadow:0 12px 30px -10px rgba(0,0,0,0.6);color:#fff;font-family:'Inter',sans-serif;font-size:13px;font-weight:600;cursor:pointer}",
      ".giiift-demo-badge .gdb-dot{width:8px;height:8px;border-radius:50%;background:#00FF9D;box-shadow:0 0 8px #00FF9D}",
      ".giiift-demo-badge .gdb-x{font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:rgba(255,255,255,0.6);background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.12);padding:4px 9px;border-radius:100px;transition:color .2s,background .2s}",
