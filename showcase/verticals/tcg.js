  ...
  V.register({
    ...
    copy: {
      ...
      wrap: {
        ...
        textTitle: 'Name the box',
        textSub: 'The words on the wrapper - they appear live as you type.',
        brandPh: 'Chase Box',
        sublabelPh: 'A PACK TO CRACK',
        notePh: 'pull something rare',
        textHint: 'Add your message, then continue to the foil.',
        continueBtn: 'Continue to the foil →',
        valueGuide: '$25 ≈ starter slabs · $50 ≈ a graded holo · $120+ ≈ vintage territory',
        designEyebrow: '// step 4 · foil',
        designTitle: 'Foil the pack',
        designSub: 'Finish, colours and the holo treatment.',
        designHint: 'Dress the box, then finalize the haul.',
