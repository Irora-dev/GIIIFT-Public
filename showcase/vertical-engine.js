  ...
  api.register({
    ...
    copy: {
      ...
      wrap: {
        ...
        textEyebrow: '// step 3 · text',
        textTitle: 'Make it yours',
        textSub: 'Write the words that go on the box - they appear live as you type.',
        brandPh: 'Name Here',
        sublabelPh: 'A GIFT FOR YOU',
        notePh: 'with love',
        textHint: 'Add your message, then continue to design.',
        continueBtn: 'Continue to design →',
        ...
        designEyebrow: '// step 4 · design',
        designTitle: 'Design the box',
        designSub: 'Finish, colours and a sticker.',
        designHint: 'Dress up the box, then finalize your gift.',
