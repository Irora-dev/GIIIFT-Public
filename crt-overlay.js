 ...
 *
 * Drop-in: add <script defer src="/crt-overlay.js"></script> to any page and it
...
(function () {
  ...
  var CSS = [
    ...
    ".crt-tl{top:96px;left:26px;display:flex;flex-direction:column;gap:2px;border-left:3px solid #44ccff;padding-left:10px}",
    ".crt-tl .lead{color:#e0faff;font-weight:600}",
    ".crt-tr{top:96px;right:26px;display:flex;align-items:center;gap:10px;background:rgba(0,0,0,0.3);padding:5px 12px}",
    ...
    ".crt-bk.tl{top:80px;left:14px;border-right:0;border-bottom:0}",
    ".crt-bk.tr{top:80px;right:14px;border-left:0;border-bottom:0}",
